      ...
      <Stack direction="row" spacing={2}>
        <Tooltip title="Click here to learn more about us.">
          <Button
            ...
            color="inherit"
            variant="outlined"
            onClick={() => window.open('https://2human.netlify.app', '_blank')}
          >
        ...
        />
        <Tooltip title="Learn about why 2HUMAN started and what problems it solves.">
          <Button
            fullWidth
            size="large"
            color="inherit"
        ...
        />
        <Tooltip title="Basic 2HUMAN tutorials.  Learn how to login to the system and use it.">
          <Button
            fullWidth
            size="large"
            color="inherit"
