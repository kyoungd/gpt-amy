...
This Agreement (“Agreement”) is made and between you, the Client. (“Company or Party”) and OYATE, LLC (OYATE, oyate or Party).  Company desires to retain oyate as an independent contractor to perform certain services for Company and  2HUMAN2human is willing to perform such services, on terms set forth more fully below.  In consideration of the mutual promises contained herein, the parties agree as follows:

1. SERVICES AND COMPENSATION
oyate agrees to perform for Company the services described in Exhibit A (“Services”), attached hereto. Company agrees to pay oyate the compensation set forth in Exhibit A for the performance of the Services. As oyate has an ongoing business providing technology solutions to its clients that include oyate’s proprietary Intellectual Property, it is anticipated that oyate may at times see value in contracting Client for its projects on like terms as provided herein, and It is further contemplated that opportunities may occur where the companies named herein will profit by combining their thoughts, skills and expertise to create new technology that can be patented and protected as proprietary. Compensation on all such projects will be dealt with outside this Agreement as “Joint Technology”.
