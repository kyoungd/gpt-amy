...
PLEASE READ THIS AGREEMENT FOR 2HUMAN’S SERVICES.  BY ACCESSING OR USING 2HUMAN’S AI  CALL INTAKE SOFTWARE OR SERVICES OFFERING, YOU (“the Customer”) SIGNIFY ACCEPTANCE OF AND AGREE TO THE TERMS AND CONDITIONS OF THIS AGREEMENT.  IF YOU DO NOT AGREE TO THE TERMS AND CONDITIONS OF THIS AGREEMENT, DO NOT ACCESS OR USE THE SERVICES.  IF THE PARTIES HAVE A FULLY EXECUTED AGREEMENT THAT EXPRESSLY GOVERNS ORDERS FOR 2HUMAN’S SOFTWARE AS A SERVICE AGREEMENT, SUCH AGREEMENT SHALL SUPERSEDE THIS AGREEMENT. 
 
This Software as a Service Agreement (“Agreement”) is entered into between Customer and 2HUMAN, LLC. a Nevada Corporation (“2HUMAN”), with its principal place of business at 1489 W Warm Springs Rd, Ste 110, Henderson, NV 89014.  2HUMAN and Customer agree that the following terms and conditions will apply to the services provided under this Agreement and Orders placed thereunder. 
 
1. DEFINITIONS 

“Administrator User” means each Customer employee designated by Customer to serve as technical administrator of the SaaS Services on Customer’s behalf.  Each Administrator User must complete training and qualification requirements reasonably required by 2HUMAN.  “Customer Content” means all data and materials provided by Customer to 2HUMAN for use in connection with the SaaS Services, including, without limitation, customer applications, data files, and graphics. “Documentation” means the user guides, online help, release notes, training materials and other documentation provided or made available by 2HUMAN to Customer regarding the use or operation of the SaaS Services. “Host” means the computer equipment on which the Software is installed, which is owned and operated by 2HUMAN or its subcontractors.   
...
“Maintenance Services” means the support and maintenance services provided by 2HUMAN to Customer pursuant to this SaaS Agreement and Exhibit B. 
“Other Services” means all technical and non-technical services performed or delivered by 2HUMAN under this SaaS Agreement, including, without limitation, implementation services and other professional services, training and education services but excluding the SaaS Services and the Maintenance Services.  Other Services will be provided on a time and material basis at such times or during such periods, as may be specified in a Schedule and mutually agreed to by the parties.  All Other Services will be provided on a non-work for hire basis.  
“Schedule" is a written document attached to this SaaS Agreement under Exhibit A or executed separately by 2HUMAN and Customer for the purpose of purchasing SaaS Services under the terms and conditions of this SaaS Agreement 
...
“SaaS Services” refer to the specific 2HUMAN’s internet-accessible service identified in a Schedule that provides use of 2HUMAN’s identity/access management Software that is hosted by 2HUMAN or its services provider and made available to Customer over a network on a term-use basis. 
“Subscription Term” shall mean that period specified in a Schedule during which Customer will have on-line access and use of the Software through 2HUMAN’s SaaS Services.  The Subscription Term shall renew for successive 12 month periods unless either party delivers written notice of non-renewal to the other party at least 30 days prior to the expiration of the then-current Subscription Term.   
...
4.3   Unauthorized Use; False Information.  Customer shall: (a) notify 2HUMAN immediately of any unauthorized use of any password or user id or any other known or suspected breach of security, (b) report to 2HUMAN immediately and use reasonable efforts to stop any unauthorized use of the SaaS Services that is known or suspected by Customer or any Identity Cube user, and (c) not provide false identity information to gain access to or use the SaaS Services. 
4.4   Administrator Access.  Customer shall be solely responsible for the acts and omissions of its Administrator Users.  2HUMAN shall not be liable for any loss of data or functionality caused directly or indirectly by the Administrator Users. 
4.5   Customer Input.  Customer is solely responsible for collecting, inputting and updating all Customer Content stored on the Host, and for ensuring that the Customer Content does not (i) include anything that actually or potentially infringes or misappropriates the copyright, trade secret, trademark or other intellectual property right of any third party, or (ii) contain anything that is obscene, defamatory, harassing, offensive or malicious.  Customer shall: (i) notify 2HUMAN immediately of any unauthorized use of any password or user id or any other known or suspected breach of security, (ii) report to 2HUMAN immediately and use reasonable efforts to stop any unauthorized use of the Service that is known or suspected by Customer or any Identity Cube user, and (iii) not provide false identity information to gain access to or use the Service. 
4.6   License from Customer.  Subject to the terms and conditions of this SaaS Agreement, Customer shall grant to 2HUMAN a limited, non-exclusive and non-transferable license, to copy, store, configure, perform, display and transmit Customer Content solely as necessary to provide the SaaS Services to Customer.   
4.7 Ownership and Restrictions.  Customer retains ownership and intellectual property rights in and to its Customer Content. 2HUMAN or its licensors retain all ownership and intellectual property rights to the services, Software programs, and anything developed and delivered under the Agreement.  Third party technology that may be appropriate or necessary for use with some 2HUMAN programs is specified in the program Documentation or ordering document as applicable. Customer’s right to use such third party technology is governed by the terms of the third party technology license agreement specified by 2HUMAN and not under the Agreement.  
4.8   Suggestions.  2HUMAN shall have a royalty-free, worldwide, irrevocable, perpetual license to use and incorporate into the SaaS Services any suggestions, enhancement requests, recommendation or other feedback provided by Customer, including Users, relating to the operation of the SaaS Services.   
...
5.2 Invoicing and Payment.  Unless otherwise provided in the Schedule, 2HUMAN shall invoice Customer for all fees on the Schedule effective date.  Customer shall pay all undisputed invoices within 30 days after Customer receives the invoice.  Except as expressly provided otherwise, fees are non-refundable.  All fees are stated in United States Dollars, and must be paid by Customer to 2HUMAN in United States Dollars. 
5.3 Expenses.  Customer will reimburse 2HUMAN for its reasonable, out-of-pocket travel and related expenses incurred in performing the Other Services.  2HUMAN shall notify Customer prior to incurring any such expense.  2HUMAN shall comply with Customer’s travel and expense policy if made available to 2HUMAN prior to the required travel.   
5.4 Taxes.  2HUMAN shall bill Customer for applicable taxes as a separate line item on each invoice.  Customer shall be responsible for payment of all sales and use taxes, value added taxes (VAT), or similar charges relating to Customer’s purchase and use of the services.  Customer shall not be liable for taxes based on 2HUMAN’s net income, capital or corporate franchise. 
...
6.3 Suspension for Non-Payment.  2HUMAN reserves the right to suspend delivery of the SaaS Services if Customer fails to timely pay any undisputed amounts due to 2HUMAN under this SaaS Agreement, but only after 2HUMAN notifies Customer of such failure and such failure continues for fifteen (15) days.  Suspension of the SaaS Services shall not release Customer of its payment obligations under this SaaS Agreement.  Customer agrees that 2HUMAN shall not be liable to Customer or to any third party for any liabilities, claims or expenses arising from or relating to suspension of the SaaS Services resulting from Customer’s nonpayment. 
6.4 Suspension for Ongoing Harm.  2HUMAN reserves the right to suspend delivery of the SaaS Services if 2HUMAN reasonably concludes that Customer or an Identity Cube user’s use of the SaaS Services is causing immediate and ongoing harm to 2HUMAN or others.  In the extraordinary case that 2HUMAN must suspend delivery of the SaaS Services, 2HUMAN shall immediately notify Customer of the suspension and the parties shall diligently attempt to resolve the issue.  2HUMAN shall not be liable to Customer or to any third party for any liabilities, claims or expenses arising from or relating to any suspension of the SaaS Services in accordance with this Section 6.4. Nothing in this Section 6.4 will limit 2HUMAN’s rights under Section 6.5 below. 

6.5 Effect of Termination. 

1. Upon termination of this SaaS Agreement or expiration of the Subscription Term, 2HUMAN shall immediately cease providing the SaaS Services and all usage rights granted under this SaaS Agreement shall terminate. 
2. If 2HUMAN terminates this SaaS Agreement due to a breach by Customer, then Customer shall immediately pay to 2HUMAN all amounts then due under this SaaS Agreement and to become due during the remaining term of this SaaS Agreement, but for such termination.  If Customer terminates this SaaS Agreement due to a breach by 2HUMAN, then 2HUMAN shall immediately repay to Customer all pre-paid amounts for any unperformed SaaS Services scheduled to be delivered after the termination date. 
...
12.1 Non-Exclusive Service.  Customer acknowledges that SaaS Services is provided on a non-exclusive basis.  Nothing shall be deemed to prevent or restrict 2HUMAN’s ability to provide the SaaS Services or other technology, including any features or functionality first developed for Customer, to other parties.   
12.2 Personal Data.  Customer hereby acknowledges and agrees that 2HUMAN’s performance of this SaaS Agreement may require 2HUMAN to process, transmit and/or store Customer personal data or the personal data of Customer employees and Affiliates. By submitting personal data to 2HUMAN, Customer agrees that 2HUMAN and its Affiliates may process, transmit and/or store personal data only to the extent necessary for, and for the sole purpose of, enabling 2HUMAN to perform its obligations to under this SaaS Agreement.  In relation to all Personal Data provided by or through Customer to 2HUMAN, Customer will be responsible as sole Data Controller for complying with all applicable data protection or similar laws such as EU Directive 95/46/EC and laws implementing that Directive that regulate the processing of Personal Data and special categories of data as such terms are defined in that Directive. Customer agrees to obtain all necessary consents and make all necessary disclosures before including Personal Data in Content and using the Enabling Software and 2HUMAN SaaS. Customer confirms that Customer is solely responsible for any Personal Data that may be contained in Content, including any information which any 2HUMAN SaaS User shares with third parties on Customer’s behalf. Customer is solely responsible for determining the purposes and means of processing Customer Personal Data by 2HUMAN under this Agreement, including that such processing according to Customer’s instructions will not place 2HUMAN in breach of applicable data protection laws. Prior to processing, Customer will inform 2HUMAN about any special categories of data contained within Customer Personal Data and any restrictions or special requirements in the processing of such special categories of data, including any cross border transfer restrictions. Customer is responsible for ensuring that the 2HUMAN SaaS meets such restrictions or special requirements. 2HUMAN to process any Personal Data that meets the requirements set forth in this Section according to these Terms of Use. 
12.3 2HUMAN Personal Data Obligations.  In performing the SaaS Services, 2HUMAN will comply with the 2HUMAN Services Privacy Policy, which is available at http://www.2HUMAN.com/privacy-policy and incorporated herein by reference. The 2HUMAN Services Privacy Policy is subject to change at 2HUMAN’s discretion; however, 2HUMAN policy changes will not result in a material reduction in the level of protection provided for Customer data during the period for which fees for the services have been paid. The services policies referenced in this SaaS Agreement specify our respective responsibilities for maintaining the security of Customer data in connection with the SaaS Services. 2HUMAN reserves the right to provide the SaaS Services from Host locations, and/or through use of subcontractors, worldwide. 2HUMAN subscribes to the United States/European Union Safe Harbor Principles, and as a result, appears on the U.S. Department of Commerce Safe Harbor list (available at http://www.export.gov/safeharbor) as of the effective date of this SaaS Agreement. 2HUMAN’s Safe Harbor certification specifically includes 2HUMAN’s performance of services for customer provided personal information.  2HUMAN will only process Customer Personal Data in a manner that is reasonably necessary to provide SaaS Services and only for that purpose. 2HUMAN will only process Customer Personal Data in delivering 2HUMAN SaaS.  Customer agrees to provide any notices and obtain any consent related to 2HUMAN’s use of the data for provisioning the SaaS Services, including those related to the collection, use, processing, transfer and disclosure of personal information.  Customer shall have sole responsibility for the accuracy, quality, integrity, legality, reliability, appropriateness and retains ownership of all of Customer data. 
...
12.11 Publicity.  2HUMAN may include Customer’s name and logo in its customer lists and on its website.  Upon signing, 2HUMAN may issue a high-level press release announcing the relationship and the manner in which Customer will use the 2HUMAN solution.  2HUMAN shall coordinate its efforts with appropriate communications personnel in Customer’s organization to secure approval of the press release if necessary. 
...
12.15 Statistical Information.   2HUMAN may anonymously compile statistical information related to the performance of the Services for purposes of improving the SaaS service, provided that such information does not identify Customer’s data or include Customer’s name. 
...
This Schedule No. A-101 ("Schedule"), effective upon the Agreement Effective Date, documents the SaaS Services (defined below) being purchased by Customer under the terms and conditions of the SaaS Agreement, between 2HUMAN LLC. (“2HUMAN”) and you (“Customer”).   
...
2HUMAN’s hosted, internet-accessible, on-demand identity and access management services for 2HUMAN’s SaaS Services for up to _______ Identity Cubes.
...
The total value of this Schedule is listed on the product page.  This fee includes access and usage of the SaaS Services during the Subscription Term for the defined number of Identity Cubes.  Upon execution of this Schedule, 2HUMAN shall issue an invoice in accordance with the SaaS Agreement.   
 
If at any time during the Subscription Term or Renewal Term the Customer exceeds the number of Identity Cubes, Customer and 2HUMAN agree to execute a follow-on schedule for the purchase of additional Identity Cubes.  Additional Identity Cubes access will be purchased in blocks of users and in accordance with the following fee.  The user fee will prorated for the remaining Subscription Term or Renewal Term. 
...
3. All extensions, enhancements and other changes that 2HUMAN, at its sole discretion, makes or adds to the Software and which 2HUMAN furnishes, without charge, to all other Subscribers of the SaaS Service. 
...
* “Problem” means a defect in Software as defined in 2HUMAN’s standard Software specification that significantly degrades such Software. 
...
Problem Severity 
	Response Goals 
	Resolution Goals 
	1. The production system is creating a significant impact to the Customer’s business function preventing that function from being executed. 2HUMAN will Respond within 2 business hours. Upon confirmation of receipt, a 2HUMAN support personnel begins continuous work on the Problem, and a customer resource must be available at any time to assist with problem determination.  Customer Support will provide reasonable effort for Workaround or Fix within 24 hours, once the Problem is reproducible or once we have identified the Software defect. 2HUMAN may incorporate Fix in future release of software. 
	2. The production system or application is moderately affected. There is no workaround currently available or the workaround is cumbersome to use. 2HUMAN will Respond within 4 business hours. Customer Support will provide reasonable effort for Workaround or Fix within 7 business days, once the Problem is reproducible. 2HUMAN may incorporate fix in future release of software. 
	3. The production system or application issue is not critical: no data has been lost, and the system has not failed.  The issue has been identified and does not hinder normal operation, or the situation may be temporarily circumvented using an available workaround. 2HUMAN will Respond within 8 business hours. Customer Support will provide reasonable effort for Workaround or Fix within 10 business days, once the Problem is reproducible. 2HUMAN may incorporate Fix in future release of software. 
	4. Non-critical issues, general questions, enhancement requests, or the functionality does not match documented specifications. 2HUMAN will Respond within 24 business hours. Resolution of Problem may appear in future release of software. 
 
3. Accessing Support

Customer Support offers several ways to resolve any technical difficulties.  In addition to online help in the Software, which can be accessed by clicking the “Help” tab when logged into the Software, function-specific help information can also be accessed throughout the Software using the ‘?’ option. The online support center (www.2HUMAN.ai/support) is available 24x7 for self-service technical assistance including:  
...
The support email address is support@2HUMAN.ai. The support phone number is 800/201-0601. 
...
(c) malicious attacks on the system, (d) issues associated with the Customer’s computing devices, local area networks or internet service provider connections, or (e) inability to deliver services because of acts or omissions of Customer or any Identity Cube user.  2HUMAN reserves the right to take the Service offline for scheduled maintenance for which Customer has been provided reasonable notice and 2HUMAN reserves the right to change its maintenance window upon prior notice to Customer. 
 
If 2HUMAN fails to meet System Availability in the year, upon written request by Customer within 30 days after the end of the year, 2HUMAN will issue a credit in Customer’s next invoice in an amount equal to 1% of the yearly fee for the affected SaaS Services for each 1% loss of System Availability below stated SLA per SaaS Service, up to a maximum of the Customer’s fee for the affected SaaS Services.  If the yearly fee has been paid in advance, then at Customer’s election 2HUMAN shall provide a credit to Customer to be used for additional Identity Cubes or term extension.  The remedy stated in this paragraph is Customer’s sole and exclusive remedy for interruption of SaaS Services and 2HUMAN’s failure to meet System Availability. 
